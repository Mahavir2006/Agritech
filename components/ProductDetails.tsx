              ...
              <div className="flex items-center space-x-2 bg-yellow-50 px-3 py-2 rounded-lg border border-yellow-200">
                <div className="flex items-center space-x-1">
                  {[1, 2, 3, 4, 5].map((star) => (
                    <Star
                      key={star}
                      className={`w-4 h-4 ${star <= Math.round(sellerRating.averageRating)
                  ...
                  {typeof analysisData.quality_score === 'number' && !isNaN(analysisData.quality_score) && (
                    <div className="space-y-1">
                      ...
                      <div className="w-full bg-gray-200 rounded-full h-2">
                        <div
                          className={`h-2 rounded-full transition-all duration-300 ${analysisData.quality_score >= 4 ? 'bg-green-500' :
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <button
                    ...
                    className={`flex-1 flex items-center justify-center space-x-2 px-6 py-3 rounded-lg transition-colors ${!onAddToCart || selectedQuantity > product.quantity
